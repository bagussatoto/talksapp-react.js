    ...
    contactList: [
      {
        ...
        contact: 'bagusbudi1308@gmail.com',
        tooltip: 'Send email',
        link: 'mailto:bagusbudi1308@gmail.com',
      },
      {
        id: 'linkedin',
        icon: AiFillLinkedin,
        contact: 'Bagus Budi Satoto',
        tooltip: 'Open Linkedin',
        link: 'https://www.linkedin.com/in/bagussatoto/',
      },
      {
        id: 'github',
        icon: AiFillGithub,
        contact: 'bagussatoto',
        tooltip: 'Open github',
        link: 'https://github.com/bagussatoto',
      },
    ],
  },
  id: {
